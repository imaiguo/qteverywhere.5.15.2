#include "CRoundExLabel.h"

CRoundExLabel::CRoundExLabel():QLabel(parent)
{
    
}

CRoundExLabel::~CRoundExLabel()
{
    
}

void CRoundExLabel::SetString(QString& str)
{
    strName = str;
}

void CRoundExLabel::paintEvent(QPaintEvent* e)
{
    if(NULL != pixmap())
    {
